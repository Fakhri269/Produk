...
document.getElementById('inputForm').addEventListener('submit', function(event) { 
    ...
    const namaProduk = document.getElementById('namaProduk').value;  const hargaSatuan = parseFloat(document.getElementById('hargaSatuan').value); 
    ...
    newRow.innerHTML = ` 
        <td>${namaProduk}</td> 
        <td>${formatRupiah(hargaSatuan.toFixed(2))}</td> 
        <td>${jumlah}</td> 
        <td>${formatRupiah(jumlahHarga.toFixed(2))}</td> 
    `; 
